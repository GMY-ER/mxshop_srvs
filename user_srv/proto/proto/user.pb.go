...
func (x *UserListRespinse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserListRespinse) ProtoMessage() {}

func (x *UserListRespinse) ProtoReflect() protoreflect.Message {
	mi := &file_user_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserListRespinse.ProtoReflect.Descriptor instead.
func (*UserListRespinse) Descriptor() ([]byte, []int) {
	return file_user_proto_rawDescGZIP(), []int{8}
}

func (x *UserListRespinse) GetTotal() int32 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *UserListRespinse) GetData() []*UserInfoResponse {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_user_proto_rawDesc = []byte{
	...
	0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x69, 0x6e, 0x73, 0x65,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xb6, 0x02,
	...
	0x1a, 0x11, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x69,
	...
	0x12, 0x34, 0x0a, 0x0e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x61, 0x73, 0x73, 0x57, 0x6f, 0x72,
	0x6c, 0x64, 0x12, 0x12, 0x2e, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x43, 0x68, 0x65,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*UserListRespinse)(nil),  // 8: UserListRespinse
	(*empty.Empty)(nil),       // 9: google.protobuf.Empty
}
var file_user_proto_depIdxs = []int32{
	7, // 0: UserListRespinse.data:type_name -> UserInfoResponse
	...
	0, // 6: User.CheckPassWorld:input_type -> PasswordCheckInfo
	8, // 7: User.GetUserList:output_type -> UserListRespinse
	...
	1, // 12: User.CheckPassWorld:output_type -> CheckResponse
...
type UserClient interface {
	GetUserList(ctx context.Context, in *PageInfo, opts ...grpc.CallOption) (*UserListRespinse, error)
...
func (c *userClient) GetUserList(ctx context.Context, in *PageInfo, opts ...grpc.CallOption) (*UserListRespinse, error) {
	out := new(UserListRespinse)
...
type UserServer interface {
	GetUserList(context.Context, *PageInfo) (*UserListRespinse, error)
...
func (*UnimplementedUserServer) GetUserList(context.Context, *PageInfo) (*UserListRespinse, error) {
